...
// Args
exports.args = ['group', 'target', 'rank', 'roleset', 'jar'];

// Define
function setRank (jar, xcsrf, group, target, roleset) {
  return function (resolve, reject) {
    var httpOpt = {
      url: 'https://www.roblox.com/groups/api/change-member-rank?groupId=' + group + '&newRoleSetId=' + roleset + '&targetUserId=' + target,
      options: {
