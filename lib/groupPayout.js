...
function groupPayout (jar, token, group, data, recurring, usePercentage) {
  return function (resolve, reject) {
    var httpOpt = {
      url: '//www.roblox.com/groups/' + group + (recurring === true ? '/recurring-payout' : ('/one-time-payout/1/' + (usePercentage === true ? 'true' : 'false'))),
      options: {
...
exports.func = function (args) {
  ...
  .then(function (xcsrf) {
    return promise(groupPayout(jar, xcsrf, args.group, data, recurring, usePercentage));
  });
};
