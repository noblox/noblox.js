 ...
 * @param {integer=} [limit=10] - The amount of users fetched by each request (10, 25, 50, 100)
 * @param {string=} [sortOrder=Asc] - The order that the returned data will be sorted by (Asc or Desc)
