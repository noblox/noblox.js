 ...
 * @category User
 * @alias getFollowers
 * @param {number} userId - The id of the user whos followers are being returned.
 * @param {integer=} [limit=10] - The amount of followers being fetched each request.
 * @param {string=} [sortOrder=Asc] - The order that the data should be sorted by (Asc or Desc)
