...
const { thumbnail: settings } = require('../options').settings
      ...
      if (statusCode === 200) {
        ...
        data = data.map(obj => {
          if (obj.state !== 'Completed') {
            const settingsUrl = settings.failedUrl[obj.state.toLowerCase()] // user defined settings default image URL for blocked or pending thumbnails; default ""
