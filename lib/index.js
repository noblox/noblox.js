...
module.exports.login = function(options,password,jar,success,failure,always) {
...
module.exports.getCurrentUser = function(options,jar,success,failure,always) {
  var callbacks = makeCallbackArray(options,success,failure,always);
  if (typeof options == 'object') {
    var j = options.jar;
...
module.exports.getRoles = function(options,rank,success,failure,always) {
  var callbacks = makeCallbackArray(options,success,failure,always);
  if (typeof options == 'object')
...
module.exports.getToken = function(options,jar,callback,failure) {
...
module.exports.setRank = function(options) {
  if (options.rank) {
...
module.exports.message = function(options,subject,body,token,jar,success,failure,always) {
  var callbacks = makeCallbackArray(options,success,failure,always);
  if (typeof options == 'object') {
    var j = options.jar;
...
// Export
module.exports.getJar = function() {
    return _jar;
};
