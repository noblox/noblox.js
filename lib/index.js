...
exports.upload = function(options, asset, jar, success, failure, always) {
  var callbacks = makeCallbackArray(options, success, failure, always);
  upload(options.jar || jar || _jar, options.data || options, options.asset || options, callbacks);
};
...
exports.post = function(options, message, jar, success, failure, always) {
  var callbacks = makeCallbackArray(options, success, failure, always);
  post(options.jar || jar || _jar, options.group || options, options.message || message, callbacks);
};
