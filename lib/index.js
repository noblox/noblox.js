...
var login = require('./util/login.js'),
  ...
  handleJoinRequest = require('./handleJoinRequest'),
...
exports.handleJoinRequest = function(options,username,accept,jar,token,success,failure,always) {
  ...
  if (typeof options == 'object') {
    var j = options.jar;
    return handleJoinRequest((j || _jar), options.token, options.group, options.username, options.accept, callbacks);
  } else
    return handleJoinRequest((jar || _jar), token, options, username, accept, callbacks);
};
