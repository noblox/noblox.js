...
noblox[
  "getUserSocialLinks"
] = require("./accountinformation/getUserSocialLinks.js");
...
noblox["cache"] = require("./cache/index.js");
...
] = require("./datastores/deleteDatastoreEntry.js");
noblox["getDatastoreEntry"] = require("./datastores/getDatastoreEntry.js");
noblox[
  "getDatastoreEntryVersions"
] = require("./datastores/getDatastoreEntryVersions.js");
...
] = require("./datastores/incrementDatastoreEntry.js");
...
] = require("./economy/getGroupRevenueSummary.js");
...
] = require("./friends/declineAllFriendRequests.js");
...
] = require("./games/checkDeveloperProductName.js");
...
//         console.log(
//           `noblox["${file.replace(".js", "")}"] = require("${
//             "./" + path.relative(__dirname, dir + "/" + file)
//           }");`
//         );
...
for (const name in noblox) {
  ...
  if (Object.prototype.hasOwnProperty.call(exporter, "func")) {
    module.exports[name] = noblox.wrap.wrapExport(
      exporter.func,
      exporter.required || [],
      exporter.optional || []
    );
