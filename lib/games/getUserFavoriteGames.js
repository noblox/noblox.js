 ...
 * @param {number} accessFilter - The  number of results per request.
 * @param {number} limit - The  number of results per request.
 * @param {number} cursor - The  number of results per request.
 * @param {number} sortOrder - The  number of results per request.
