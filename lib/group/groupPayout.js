 ...
 * @param {number | Array} member(s) - The member or array of members to payout.
 * @param {number} amount - The amount of robux for each recipent to recieve.
 ...
 * noblox.groupPayout(1117747196, "Item", "A cool item.")
**/
