 ...
 * @category Group
 * @alias getRole
 * @param {number | Array} group | roles - The id of the group or an array of roles.
 * @param {number | String} rankId | rankName - The rank's id, roleset id, or the name of the rank.
