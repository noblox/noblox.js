...
Authentication is pretty simple, it's how Roblox knows who you are and what account you're using. Since Roblox uses FunCaptcha and have no official bot system, developers are forced to use account [**cookies.**](https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer) This will allow Roblox to easily identify your bot's account and execute actions.
