...
type DevForumUser = {
    ...
    featured_topic?: Array<DevForumTopic>;
    bio_excerpt?: string;
    website?: string;
    website_name?: string;
    location?: string;
...
*/
type DevForumInfo = {
    user_badges: Array<DevForumUserBadges>;
    badges: Array<DevForumBadges>;
    badge_types: Array<DevForumBadgeTypes>;
    users: Array<DevForumUser>;
    topics: Array<DevForumTopic>;
    user: DevForumUser;
}
